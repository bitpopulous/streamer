...
class ExternalChannel extends PublicChannel
{
	// public $channels;
	protected $CI;
	public $wss_server;
	...
	public function _push_event_to_public_channels(array $channels)
	{
		foreach ($channels as $channel => $eventData) {
			foreach ($eventData as $e) {
				parent::_send_to_subscribers($e['event'], $channel, (array) $e['data']);
			}
		}
	}
